            ...
            {schoolDetailLoading ? (
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-x-3 gap-y-2 text-[13px]">
                  ...
                  <span className="col-span-2"><AdminPill tone={planTone(schoolDetailData.school.plan as AdminSchoolRow['plan'])}>{schoolDetailData.school.plan}</AdminPill></span>
                  <span className="font-semibold text-[#6d665d]">State</span>
                  <span className="col-span-2"><AdminPill tone={billingTone(schoolDetailData.school.state as any)}>{schoolDetailData.school.state}</AdminPill></span>
