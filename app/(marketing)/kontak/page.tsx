          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-unit-12 items-start">
            <div className="lg:col-span-6 flex flex-col gap-unit-8">
              ...
              <div className="flex flex-col gap-unit-6">
                <div className="flex items-start gap-unit-4">
                  <span
                    className="material-symbols-outlined text-burgundy text-[24px] mt-0.5"
            ...
            <div className="lg:col-span-5 lg:col-start-8">
              <form
                ...
                className="bg-paper border border-border-strong rounded-2xl p-unit-8 flex flex-col gap-unit-4"
              >
                <h2 className="font-h3 text-h3 text-ink mb-unit-2">Kirim pesan</h2>
                <div>
                  <label
                    htmlFor="contact-name"
                    className="font-label-semibold text-caption text-ink block mb-1"
                  >
                    Nama
                  </label>
                  <input
                    ...
                    className="w-full bg-surface border border-border-strong rounded-lg px-4 py-3 text-body-sm focus:outline-none focus:border-burgundy focus:ring-1 focus:ring-burgundy transition-all"
                  />
                </div>
                <div>
                  <label
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-surface border border-border-strong rounded-lg px-4 py-3 text-body-sm focus:outline-none focus:border-burgundy focus:ring-1 focus:ring-burgundy transition-all resize-none"
                  />
                </div>
                <button
                  type="submit"
                  className="bg-burgundy text-on-primary font-label-semibold h-[48px] rounded-lg text-body-default hover:brightness-110 active:scale-[0.98] transition-all mt-unit-2"
                >
                  Kirim Pesan
                </button>
              </form>
